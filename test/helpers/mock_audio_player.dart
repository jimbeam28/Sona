...
class MockAudioPlayer extends Mock implements AudioPlayer {
  ...
  Stream<bool> get playingStream =>
      super.noSuchMethod(Invocation.getter(#playingStream),
          ...
          returnValueForMissingStub: Stream<bool>.empty()) as Stream<bool>;

  @override
  Stream<double> get volumeStream =>
      super.noSuchMethod(Invocation.getter(#volumeStream),
          returnValue: Stream<double>.empty(),
          returnValueForMissingStub: Stream<double>.empty()) as Stream<double>;
  ...
  @override
  Stream<List<IndexedAudioSource>?> get sequenceStream => super.noSuchMethod(
  ...
  Stream<int?> get currentIndexStream =>
      super.noSuchMethod(Invocation.getter(#currentIndexStream),
          ...
          returnValueForMissingStub: Stream<int?>.empty()) as Stream<int?>;
  ...
  @override
  Stream<LoopMode> get loopModeStream => super.noSuchMethod(
      Invocation.getter(#loopModeStream),
      returnValue: Stream<LoopMode>.empty(),
      returnValueForMissingStub: Stream<LoopMode>.empty()) as Stream<LoopMode>;
  ...
  PlaybackEvent get playbackEvent =>
      super.noSuchMethod(Invocation.getter(#playbackEvent),
          ...
          returnValueForMissingStub: PlaybackEvent()) as PlaybackEvent;

  @override
  ProcessingState get processingState =>
      super.noSuchMethod(Invocation.getter(#processingState),
          returnValue: ProcessingState.idle,
          returnValueForMissingStub: ProcessingState.idle) as ProcessingState;
  ...
  LoopMode get loopMode => super.noSuchMethod(Invocation.getter(#loopMode),
      returnValue: LoopMode.off,
      returnValueForMissingStub: LoopMode.off) as LoopMode;
  ...
  Future<void> setSkipSilenceEnabled(bool enabled) =>
      super.noSuchMethod(Invocation.method(#setSkipSilenceEnabled, [enabled]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as Future<void>;
  ...
  Future<void> setAutomaticallyWaitsToMinimizeStalling(bool value) =>
      super.noSuchMethod(
          Invocation.method(#setAutomaticallyWaitsToMinimizeStalling, [value]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as Future<void>;
  ...
  Future<void> setPreferredPeakBitRate(double value) =>
      super.noSuchMethod(Invocation.method(#setPreferredPeakBitRate, [value]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as Future<void>;

  @override
  Future<void> setAllowsExternalPlayback(bool value) =>
      super.noSuchMethod(Invocation.method(#setAllowsExternalPlayback, [value]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as Future<void>;
  ...
  @override
  Future<Duration?> setClip({Duration? start, Duration? end, dynamic tag}) =>
      super.noSuchMethod(
