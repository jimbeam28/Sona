...
// in nas_audio_player/test/features/coverage/aud_03_error_injection_test.dart.
...
/// A class which mocks [ActiveConnectionProvider].
///
/// See the documentation for Mockito's code generation for more information.
class MockActiveConnectionProvider extends _i1.Mock
    implements _i6.ActiveConnectionProvider {
  MockActiveConnectionProvider() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<_i7.ConnectionConfig?> getActiveConnection() =>
      (super.noSuchMethod(
        Invocation.method(
          #getActiveConnection,
          [],
        ),
        returnValue: _i3.Future<_i7.ConnectionConfig?>.value(),
      ) as _i3.Future<_i7.ConnectionConfig?>);
}

/// A class which mocks [PasswordReader].
///
/// See the documentation for Mockito's code generation for more information.
class MockPasswordReader extends _i1.Mock implements _i6.PasswordReader {
  MockPasswordReader() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<String?> readPassword(int? connectionId) => (super.noSuchMethod(
        Invocation.method(
          #readPassword,
          [connectionId],
        ),
...
/// A class which mocks [ProgressSaver].
///
/// See the documentation for Mockito's code generation for more information.
class MockProgressSaver extends _i1.Mock implements _i6.ProgressSaver {
  MockProgressSaver() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<void> upsertProgress({
...
/// A class which mocks [DefaultSpeedProvider].
///
/// See the documentation for Mockito's code generation for more information.
class MockDefaultSpeedProvider extends _i1.Mock
    implements _i6.DefaultSpeedProvider {
  MockDefaultSpeedProvider() {
    _i1.throwOnMissingStub(this);
  }

  @override
  double getDefaultSpeed() => (super.noSuchMethod(
        Invocation.method(
          #getDefaultSpeed,
          [],
        ),
...
/// A class which mocks [QueueConnectionIdProvider].
///
/// See the documentation for Mockito's code generation for more information.
class MockQueueConnectionIdProvider extends _i1.Mock
    implements _i6.QueueConnectionIdProvider {
  MockQueueConnectionIdProvider() {
    _i1.throwOnMissingStub(this);
  }
}
