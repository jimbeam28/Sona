...
|---|---|---|---|---|---|---|---|---|
| BUG-04 | Shuffle 排列一致性缺陷簇 | draft | 2026-07-27 | `lib/shared/models/play_queue.dart` | null（跨模块） | PLY, BRW | 4/3/2 | pending / pending / pending |
...
| BUG-10 | 删除活跃连接后不复位导航栈 | draft | 2026-07-27 | `lib/features/connection/connection_provider.dart` | Connection | BRW | 1/1/0 | pending / pending / pending |
...
| BUG-18 | loadAndPlay 12s 轮询等待播放开始 | draft | 2026-07-27 | `lib/features/player/domain/playback_orchestrator.dart` | null（跨模块） | PLY | 0/2/0 | pending / pending / pending |
...
| BUG-22 | 音频焦点死代码 + 无超时（SVC2 + SVC3） | draft | 2026-07-27 | `lib/core/services/audio_handler.dart` | Player | PLY | 2/3/0 | pending / pending / pending |
...
| BUG-25 | 播放单健壮性（LIST3+LIST5+LIST6+LIST7+LIST8） | draft | 2026-07-27 | `lib/features/playlist/domain/playlist_service.dart` | Playlist | PLY | 5/6/0 | pending / pending / pending |
...
| BUG-32 | 服务层健壮性（SVC4+SVC5） | draft | 2026-07-27 | `lib/core/services/storage_utils.dart` | null（跨模块） | CON, PLY, BRW | 2/3/0 | pending / pending / pending |
